...
### Recursos disponibilizados
  ...
  | Categoria | PUT | http://localhost:8000/api/categories/<id> | Cria uma nova categoria. Necessário informar, formato *JSON*, parâmetros no body da requisição |
  ...
  | Gênero | PUT | http://localhost:8000/api/genders/<id> | Criará um novo gênero. Necessário informar, formato *JSON*, parâmetros exigidos no body da requisição |
