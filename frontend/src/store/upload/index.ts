...
export const {Types, Creators} = createActions<{
    ...
    uploadProgress(payload: Typings.UpdateProgressAction['payload']): Typings.UpdateProgressAction
...
const reducer = createReducer<Typings.UploadState, Typings.Actions>( INITIAL_STATE, {
    ...
    [Types.UPLOAD_PROGRESS]: uploadProgress as any,
...
function uploadProgress(state: Typings.UploadState = INITIAL_STATE, action: Typings.UpdateProgressAction): Typings.UploadState {
